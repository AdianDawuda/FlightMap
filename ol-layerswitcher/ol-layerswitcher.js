...
let LayerSwitcher = function (_Control) {
    ...
    function LayerSwitcher(opt_options) {
        ...
        let _this = possibleConstructorReturn(this, (LayerSwitcher.__proto__ || Object.getPrototypeOf(LayerSwitcher)).call(this, { element: element, target: options.target }));
    ...
    createClass(LayerSwitcher, [{
        ...
        value: function renderPanel(map, panel, options) {
            // Create the event.
            let render_event = new Event('render');
            // Dispatch the event.
            ...
            // Create the event.
            let rendercomplete_event = new Event('rendercomplete');
            // Dispatch the event.
        ...
        value: function isBaseGroup(grp) {
            if (grp instanceof LayerGroup) {
                let lyrs = grp.getLayers().getArray();
        ...
        value: function setGroupVisibility(map) {
            ...
            let groups = LayerSwitcher.getGroupsAndLayers(map, function (l) {
                return l instanceof LayerGroup && !l.get('combine') && !LayerSwitcher.isBaseGroup(l);
            }).reverse();
            // console.log(groups.map(g => g.get('title')));
            groups.forEach(function (grp) {
                // TODO Can we use getLayersArray, is it public in the esm build?
                let descendantVisibility = grp.getLayersArray().map(function (l) {
        ...
        value: function setChildVisibility(map) {
            ...
            groups.forEach(function (grp) {
                ...
                let groupVisible = group.getVisible();
                let groupIndeterminate = group.get('indeterminate');
        ...
        value: function renderLayer_(map, lyr, idx, options, render) {
            ...
            let checkboxId = LayerSwitcher.uuid();
            let label = document.createElement('label');
            if (lyr instanceof LayerGroup && !lyr.get('combine')) {
                let isBaseGroup = LayerSwitcher.isBaseGroup(lyr);
                ...
                label.htmlFor = checkboxId;
                label.innerHTML = lyrTitle;
                let rsl = map.getView().getResolution();
